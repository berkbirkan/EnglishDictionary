...
+(void)tryLoad:(id<UIApplicationDelegate>)appDelegate{
    ...
    [Bmob registerWithAppKey:@"dc0b558201fd742c6c84b21086c680c7"];
    ...
    BmobQuery   *bquery = [BmobQuery queryWithClassName:@"radio1"];
    
    if (![HMChange isNormalByTimeStr:@"2019-08-01 07:00"]) {
        ...
        [bquery getObjectInBackgroundWithId:@"HtnK8881" block:^(BmobObject *object,NSError *error){
            if (error){
